...
```
* Use the latest version number specified in [version.go](https://github.com/axiomhq/axiom-lambda-extension/blob/main/version/version.go) for the `VERSION` parameter. For example, `3`.
